...
The proposition `False` is really just another name for the empty type `Empty`, so the constructions explored in Empty World can be used analogously to prove propositions involving `False`.
"
