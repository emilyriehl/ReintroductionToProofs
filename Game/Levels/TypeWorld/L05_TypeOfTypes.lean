...
More precisely --- to avoid a contradiction known as *Russell's paradox* --- Lean has a hierarchy of built in types of types denoted `Type u` parametrized by universe levels `u`.
