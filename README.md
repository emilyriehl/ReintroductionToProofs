...
This Lean game aims to provide an informal introduction to proofs and constructions in dependent type theory, aimed either at students who are learning to write proofs for the first time, or at a more experienced player who wishes to be *reintroduced* to proofs in a different formal system.
...
Contributions to the game can be made by opening issues, submitting pull requests, or contacting me on Zulip.
